...
It was built by [Santiago Fernández de Valderrama](https://santifer.io/about) to manage a real job search — 740+ offers evaluated, one Head of Applied AI role landed. He open sourced it so anyone could use the same system for free.
